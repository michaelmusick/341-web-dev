...
Please read this [Wikipedia page on text editors][1] to familiarize yourself with some of the specifics and differences. Pay particular attentions to the “Typical Features” section.
...
- GitHub’s [Atom][2] - Open Source (ie. Free)
- Adobe’s [Brackets][3] - Open Source
- [Sublime Text 3][4] - License is $70
...
![example search for newfound-syntax-theme][image-1]
...
More can be found on the [scotch websites discussion of Atom][5]
...
[2]:	https://atom.io
[3]:	http://brackets.io
[4]:	https://www.sublimetext.com/3
[5]:	https://scotch.io/bar-talk/best-of-atom-features-plugins-acting-like-sublime-text

[image-1]:	imgs/theme_search_in_atom.jpg
[image-2]:	imgs/textDocExam.jpg